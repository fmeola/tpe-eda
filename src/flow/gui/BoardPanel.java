...
public class BoardPanel extends JPanel {
	...
	/**
	 * Coloca una imagen en una celda determinada. Si la celda ya conten������a otra imagen,
	...
	/**
	 * Superpone una imagen sobre una celda. Si la celda est������ vac������a, es equivalente a 
	 * usar {@code setImage}. Si la celda no est������ vac������a y la imagen a superponer contiene transparencias,
	...
	public void setBoard(int[][] board, HashMap<Integer,Image> imageMap) {
		for (int i =0; i < board.length; i++) {
			for (int j = 0; j < board[0].length; j++) {
				this.clearImage(i, j);
				this.appendImage(i,j, imageMap.get(board[i][j]));
			}
		}
		repaint();
	}
